...
class Restauran extends StatefulWidget {
  String strRuta;
  String strAlimento;
  ...
  @override
  _RestauranState createState() => _RestauranState();
}

class _RestauranState extends State<Restauran> {
  @override
            ...
            child: Container(
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(widget.strRuta),
                  )),
            ),
          ),
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                    child: Container(
                  child: Text(widget.strDescripcion),
                ))
              ],
            ),
          ),
          ...
          Expanded(
            ...
            child: Container(
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage('assets/images/amburguesa.png'),
                  )),
            ),
          ),
          Expanded(
                                      ...
                                      child: ListView(
                                        ...
                                        children: <Widget>[
                                          Recomendados(
                                              ...
                                              4),
                                          Recomendados(
                                              'assets/Imagenes/amburguesa.jpg',
                                              'Boxito Lindo',
